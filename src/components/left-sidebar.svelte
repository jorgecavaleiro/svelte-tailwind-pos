...
<div class="flex flex-row w-auto flex-shrink-0 pl-4 pr-2 py-4">
  ...
  >
    ...
    <ul class="flex flex-col space-y-2 mt-12">
      <li>
        ...
        <a class="flex items-center">
          <span
            class={isPosActive
              ? "bg-green-300 shadow-lg text-white flex items-center justify-center h-12 w-12 rounded-full"
              : "hover:bg-green-400 hover:cursor-pointer text-green-100 flex items-center justify-center h-12 w-12 rounded-full"}
          >
            <svg
      ...
      <li>
        ...
        <a class="flex items-center">
          <span
            class="flex items-center justify-center text-green-100 hover:bg-green-400 hover:cursor-pointer h-12 w-12 rounded-full"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
    ...
    <a
      ...
      target="_blank"
      rel="noreferrer"
      class="mt-auto flex items-center justify-center text-green-200 hover:text-green-100 h-10 w-10 focus:outline-none"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-8 w-8"
